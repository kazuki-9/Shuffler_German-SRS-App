...
## Setup
1. On your laptop or desktop PC, access the Template: Open [Shuffler Google Sheet](https://docs.google.com/spreadsheets/d/1bqQFczcFHB5y_KDal2aDHsPy3q_e-2RImxaUPAmfX5E/edit?usp=sharing) (Although this system is designed to be used on smartphones, this initial Setup, including accessing the App Script and giving the permissions must be done on a desktop browser)
